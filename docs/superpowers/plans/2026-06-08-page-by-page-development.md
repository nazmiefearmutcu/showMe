...
- [ ] **Task 1: HOME — Overview.** Pane: `ui/src/panes/Welcome.tsx` (+ `Welcome.test.tsx`, `Welcome.cascade.test.tsx`, `Welcome.sentiment.test.tsx`). Backend: market snapshot/sentiment feeds. Focus: first-screen impact, live tiles, navigation affordances.
- [ ] **Task 2: WATCH — Live Watchlist.** Pane: `ui/src/functions/WATCH.tsx`. Backend: quotes/streaming provider. Focus: live updates, add/remove symbols, sparkline/quote density, empty state.
...
- [ ] **Task 9: GEX — Gamma Exposure.** Pane: `ui/src/functions/GEX.tsx`. Backend: `backend/showme/engine/functions/derivative/gex.py`. Focus: gamma profile chart, strikes data sufficiency, dealer-positioning display.
- [ ] **Task 10: FA — Financial Analysis.** Pane: `ui/src/functions/FA.tsx`. Backend: fundamentals provider (SEC EDGAR). Focus: statements, ratios, real filings data, table quality.
...
- [ ] **Task 14: INSTANT — Trade Ticket (Instant Squawk Line).** Pane: `ui/src/functions/INSTANT.tsx`. Backend: `backend/showme/engine/functions/trade/`. Focus: ticket UX, order fields, validation, squawk feed.
...
- [ ] **Task 19: BOTS — Bot Supervision.** Pane: `ui/src/functions/BOTS.tsx`. Backend: `backend/showme/bots`. Focus: supervision view, health/metrics, controls.
- [ ] **Task 20: PERF — Performance.** Pane: `ui/src/functions/PERF.tsx`. Backend: performance/leaderboard. Focus: cumulative perf charts, real metrics, leaderboard table.
...
- [ ] **Task 25: AGENT — Symbol Agent.** Pane: `ui/src/functions/AGENT.tsx`. Backend: `backend/showme/agents`. Focus: ranked function set per symbol, relevance, display.
- [ ] **Task 26: ASK — Ask.** Pane: `ui/src/functions/ASK.tsx`. Backend: assistant/research. Focus: query UX, answer rendering, function-backed citations.
