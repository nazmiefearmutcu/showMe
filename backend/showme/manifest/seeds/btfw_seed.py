...
def btfw() -> FunctionManifest:
    return FunctionManifest(
        ...
        methodology=(
            ...
            "sliding train of fixed length), grid-search the strategy's "
            "fittable parameters on the train slice, then evaluate signals "
            "on the test slice with commission charged on the notional "
            "actually traded. Slippage is not modelled separately — "
            "commission_bps is the only cost applied. The OOS equity is the "
