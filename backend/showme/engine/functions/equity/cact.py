...
from showme.engine.functions.equity._common import FIELD_DICTIONARIES, date_label, finite, frame_rows, series_rows
            ...
            if self.deps.sec_edgar:
                ...
                if hasattr(sec_filings, "to_dict") and "form" in sec_filings.columns:
                    ...
                    if params.get("fetch_documents") or params.get("deep"):
                        ...
                        if cik:
                            from showme.engine.core.sec_taxonomy import categorize_8k_text
                            for _, row in eight_k_rows.iterrows():
                                try:
